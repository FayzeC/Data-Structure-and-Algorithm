...
int isStackPairwiseConsecutive(Stack *s)
{
	// return 1 if pairwise else 0
	// My answer (does not preserve values of original stack but its shorter :3)
	...
	/* Model Answer (Stack preserved but in reverse order)
	Stack temp;
	temp.ll.head = NULL;
	temp.ll.size = 0 ;
