...
int hasGreatGrandchild(BTNode *node){
    ...
    if(r > l){
        l = r; // update l to the maxdepth obtained from left and right subtree
    }
    ...
    return l+1; // returns the depth of the current subtree plus 1, indicating the depth of the subtree rooted at the current node.
}
